...
from slr.core.config import DeduplicationConfig, DeduplicationStrategy as StrategyEnum
from slr.core.models import Document, DocumentCluster
from slr.dedup.strategies import ConservativeStrategy, HybridStrategy, SemanticStrategy
...
class Deduplicator:
    ...
    Example:
        >>> from slr.core.config import DeduplicationConfig, DeduplicationStrategy
